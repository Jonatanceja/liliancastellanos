<section class="bg-cover bg-center my-10 relative max-w-6xl mx-auto space-y-10 px-5">
    ...
    <div class="grid grid-cols-2 md:grid-cols-3 gap-5 md:gap-20 max-w-6xl mx-auto relative z-10">
        @foreach ($page->gallery()->toFiles() as $item)
            <div>
                ...
                <div class="py-5 space-y-5">
                    <h4 class="text-blue-800 text-lg md:text-2xl italic">"{{ $item->caption() }}"</h4>
                    <x-elements.divider />
                </div>
            </div>
        @endforeach
